...
事業者登録時の銀行口座情報、身分証明書の登録は、Active Storageを利用してファイルアップロード機能を実装し、安全に保管する。
使用gem・技術:stripe、Twilio
...
ユーザーの言語設定に応じて、表示言語を切り替える。
i18n-js gemを使うことで、JavaScriptで使用する文言も国際化対応できる
